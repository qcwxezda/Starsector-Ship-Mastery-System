...
public class DimensionalLink extends BaseHullMod {
    ...
    public static final String EXISTING_REPAIR_SCRIPTS_KEY = "$sms_DimensionalLinkScripts";
            ...
            if (damageAmount >= ship.getHitpoints() && !isRetreating) {
                ...
                CombatDeferredActionPlugin.performLater(() -> {
                    ...
                    CombatDeferredActionPlugin.performLater(() -> {
                        ...
                        fm.getRepairTracker().applyCREvent(-crLoss, Strings.Skills.dimensionalLinkRetreatText);
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        tooltip.addPara(
                Strings.Skills.dimensionalLinkEffect,
                8f,
