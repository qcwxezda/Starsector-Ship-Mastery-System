...
public interface Strings {
    ...
    String SMOD_CREDITS_REDUCTION = Utils.getString("sms_descriptions", "reduceSModCreditsCost");
    String SMOD_CREDITS_REDUCTION_NEG = Utils.getString("sms_descriptions", "reduceSModCreditsCostNeg");
    String SMOD_MP_REDUCTION = Utils.getString("sms_descriptions", "reduceSModMPCost");
    String SMOD_MP_REDUCTION_NEG = Utils.getString("sms_descriptions", "reduceSModMPCostNeg");
    String REDUCE_RESTORATION_COST = Utils.getString("sms_descriptions", "reduceRestorationCost");
    String REDUCE_RESTORATION_COST_NEG = Utils.getString("sms_descriptions", "reduceRestorationCostNeg");
    String ENABLE_SMOD_REMOVAL = Utils.getString("sms_descriptions", "enableSModRemoval");
    String ENABLE_SMOD_REMOVAL_POST = Utils.getString("sms_descriptions", "enableSModRemovalPost");
    String ALLOW_OVER_CAPACITY_SMOD_SINGLE = Utils.getString("sms_descriptions", "allowOverCapacitySModsSingle");
    String ALLOW_OVER_CAPACITY_SMOD_PLURAL = Utils.getString("sms_descriptions", "allowOverCapacitySModsPlural");
    String ALLOW_OVER_CAPACITY_SMOD_POST = Utils.getString("sms_descriptions", "allowOverCapacitySModsPost");
    String IGNORE_NO_BUILD_IN = Utils.getString("sms_descriptions", "ignoreNoBuildIn");
